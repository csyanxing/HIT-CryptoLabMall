...
public class GoodDetail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String goodID = getParams(req, privExpString, modulusString).get("goodID");
        if (goodID == null) {
        ...
        req.setAttribute("good", goodList.get(0));
        JdbcUtils.close(rs, prep, conn);
        req.getRequestDispatcher("showgoods/goodDetail.jsp").forward(req, resp);
    }
    ...
    private Map<String, String> getParams(HttpServletRequest req, String privExpString, String modulusString) {
        ...
        String goodID = null;
        String encryptedGoodID = req.getParameter("encryptedGoodID");
...
//        System.out.println("解密得到的对称密钥: " + symKey);
        String decryptedGoodID = AESUtils.AESDecrypt(symKey, encryptedGoodID);
        goodID = decryptedGoodID;
