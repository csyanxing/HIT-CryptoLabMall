...
import top.hityx.cryptomall.utils.GraphicHelper;
...
public class SellerLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("seller_login/seller_login.jsp").forward(req, resp);
    }
...
//        System.out.println(params);
        ...
        if (checkCode == null || !(checkCode.equals(req.getSession().getAttribute("checkCode")))) {
            ...
            req.getRequestDispatcher("/seller_login/login_fail.jsp").forward(req, resp);
            return;
        }
        ...
        try {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement("SELECT * FROM mall_sellers where seller_username=? and seller_password_hash=?");
            ...
            if (rs.next()) {
                ...
                req.getSession().setAttribute("userType", "seller");
                req.getSession().setAttribute("sellerUsername", username);
                resp.sendRedirect(contextPath + "/seller_login/login_success.jsp");
            } else {
                //失败
