...
public class ConsumerRegister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("买家访问了注册页面");
        req.getRequestDispatcher("/consumer_login/consumer_register.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (checkCode == null || !(checkCode.equals(req.getSession().getAttribute("checkCode")))) {
            ...
            req.getRequestDispatcher("/consumer_login/register_fail.jsp").forward(req, resp);
            return;
        }
        ...
        try {
            preparedStatement = connection.prepareStatement("SELECT * FROM mall_consumers where consumer_username=?");
        ...
        try {
            pre = conn.prepareStatement("INSERT INTO mall_consumers VALUES (null, ?, ?, ?)");
            pre.setString(1, username);
            pre.setString(2, sha256Password);
            pre.setString(3, cert);
        ...
        resp.sendRedirect(contextPath + "/consumer_login/register_success.jsp");
