...
<head>
    ...
    <style>
        * {
        ...
        #username, #password, #password2, #email, #name, #tel, #birthday, #cert {
            width: 251px;
            height: 32px;
    ...
    <script>
        ...
        function registerSubmit() {
            ...
            var cert = registerForm.cert.value;
            ...
            httpPost("${pageContext.request.contextPath}/consumerRegister", params);
        }
...
<div class="rg_layout">
        ...
        <div class="rg_form">
            ...
            <form action="/sellerRegister" method="post" id="registerForm">
                <table>
                    ...
                    <tr>
                        <td class="td_left">证书</td>
                        <td class="td_right">
                            <textarea name="cert" id="cert" cols="30" rows="100" style="height: 100px" placeholder="请在此粘贴您的证书内容"></textarea>
                        </td>
                    </tr>
                    <tr>
    ...
    <div class="rg_right">
        <p>已有账号?&nbsp; <a href="${pageContext.request.contextPath}/consumerLogin">&nbsp;立即登录&nbsp;</a></p>
    </div>
    <br>
    <br>
    <div class="rg_right">
