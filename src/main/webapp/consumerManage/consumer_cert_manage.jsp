    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/consumerCertManage" style="font-size: large;">证书信息</a></li>
            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

            <h1>证书信息</h1>
            <form action="${pageContext.request.contextPath}/consumerCertManage" method="post">
                <table style="align-items: center; font-weight: bold;" border="3px">
                    <tr>
                        <td align="center" valign="middle" style="width: 300px;">
                            <textarea name="cert" id="cert" cols="120" rows="20">${certInfo}</textarea>
                        </td>
                    </tr>
                </table>
